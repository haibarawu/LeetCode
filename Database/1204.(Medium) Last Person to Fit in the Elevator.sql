...
In the example George Washington(id 5), John Adams(id 3) and Thomas Jefferson(id 6) will enter the elevator,
as their weight sum is 250 + 350 + 400 = 1000.
...
(
  SELECT q1.person_name, SUM(q2.weight) AS weights
